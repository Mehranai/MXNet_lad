...
if __name__ == '__main__':
    ...
    if not args.eval_all:
        loaded_par = '/home/mehran/Desktop/Human-Object-Relation-Network-master/experiments/Stanford40/horelation_resnet50_v1d_st40_best.params'
        logger.info('[Model: {}] Start Evaluation'.format(args.pretrained))
        net.load_parameters(loaded_par)
